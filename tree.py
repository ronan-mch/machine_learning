...
best_model, scorechart = fwd.forward_select(train, [], data.columns.drop('Survived'), 1, fwd.score_tree, target='Survived')
gen_est_errors = fwd.estimate_generalisation_errors(scorechart, train, gen_test, fwd.score_tree, 'Survived')
